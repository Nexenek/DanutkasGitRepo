...
<body>
	...
	<aside id="glowny">
		...
		<?php
			$zap2="SELECT DISTINCT s.data_ur, s.miot, r.rasa FROM swinki s, rasy r WHERE r.id=s.rasy_id AND s.rasy_id=7";
		...
		<?php
			$zap3="SELECT imie, cena, opis FROM swinki WHERE rasy_id=7";
